...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'ankitk25564@gmail.com',
    href: 'mailto:ankitk25564@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    ...
    href: 'https://wa.me/919599229686',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/ankit-kumar-1096a0338',
    href: 'https://www.linkedin.com/in/ankit-kumar-1096a0338/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@ankitk255643-ctrl',
    href: 'https://github.com/ankitk255643-ctrl',
  },
];
