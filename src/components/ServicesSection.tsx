...
const SERVICES = [
  ...
  {
    number: '06',
    title: 'AI Command Centers & Autonomous Agents',
    description:
      'Designing and deploying intelligent, personalized agent frameworks (like Chitti Robo) — incorporating natural language routing, voice command execution, and automated workflow orchestrations.',
  },
];
